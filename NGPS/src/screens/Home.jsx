    ...
    <div className="min-h-screen bg-[#FFFEF7]">
      ...
      <main className="relative z-10">
        ...
        <section className="py-16 bg-[#111827] text-white">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold outfit">
                What Our Clients Say
              </h2>
              <div className="w-24 h-1 mx-auto my-4 bg-[#93C5FD]"></div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20">
                ...
                <p className="text-gray-200 mb-6 italic outfit">
                  "NexGen's mock USFDA audit identified critical gaps we missed internally. Their remediation roadmap saved us months of rework. Highly professional team."
                </p>
                <p className="font-semibold outfit">— QA Head, API Manufacturer</p>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20">
                ...
                <p className="text-gray-200 mb-6 italic outfit">
                  "Excellent support on DMF updates and authority responses. Clear documentation, fast turnaround. They understand regulatory expectations."
                </p>
                <p className="font-semibold outfit">— RA Manager, Sterile Injectable Facility</p>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20">
                ...
                <p className="text-gray-200 mb-6 italic outfit">
                  "Computer system validation done right—no shortcuts. Their GAMP 5 approach met both USFDA and EDQM expectations. Worth every rupee."
                </p>
                <p className="font-semibold outfit">— IT Head, FDF Manufacturing Plant</p>
              </div>
            </div>
          </div>
        </section>
