          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="flex flex-col md:flex-row gap-4 justify-center items-center mt-8">
              ...
              <a
                ...
                className="flex items-center gap-2 px-8 py-3 bg-white text-[#201E1D] hover:bg-gray-100 font-semibold rounded-lg transition-all duration-200 shadow-lg"
              >
        ...
        <section className="py-16 px-4 bg-white">
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
              {/*------------------------------------------ Location ------------------------------------------*/}
              <div className="bg-[#F9F4ED] p-8 rounded-lg text-center hover:shadow-lg transition-shadow">
                ...
                <h3 className="text-xl font-semibold outfit text-[#201E1D] mb-3">Our Location</h3>
                ...
                <a 
                  ...
                  className="inline-block mt-3 text-[#8C491A] hover:text-[#B2622D] transition-colors text-sm font-medium"
                >
                  View on Google Maps →
                </a>
              </div>
              ...
              <div className="bg-[#F9F4ED] p-8 rounded-lg text-center hover:shadow-lg transition-shadow">
                ...
                <h3 className="text-xl font-semibold outfit text-[#201E1D] mb-3">Email Us</h3>
                <a href="mailto:inquiry@nexgenpharmasolutions.com" className="text-gray-600 montserrat hover:text-[#8C491A] transition-colors text-sm">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {/*------------------------------------------ Google Map ------------------------------------------*/}
              <div className="bg-[#F9F4ED] p-4 rounded-lg shadow-md">
                <h3 className="text-xl font-semibold outfit text-[#201E1D] mb-4">Find Us</h3>
                ...
                <div className="mt-4 flex flex-col sm:flex-row gap-3">
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="flex-1 bg-[#AA5C29] hover:bg-[#8C491A] text-white py-3 px-4 rounded-lg transition-colors text-center font-medium outfit flex items-center justify-center gap-2"
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="flex-1 bg-white hover:bg-gray-50 text-[#8C491A] border-2 border-[#C67139] py-3 px-4 rounded-lg transition-colors text-center font-medium outfit flex items-center justify-center gap-2"
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {/*------------------------------------------ Contact Form ------------------------------------------*/}
              <div className="bg-[#F9F4ED] p-6 rounded-lg shadow-md" id="contact-form">
                <h3 className="text-xl font-semibold outfit text-[#201E1D] mb-4">Send Us a Message</h3>
                <form className="space-y-4" onSubmit={onSubmit}>
                  ...
                  {/*------------------------------------------ Name Input ------------------------------------------*/}
                  <div>
                    <label className="block text-[#201E1D] font-medium mb-2 outfit text-sm">
                    ...
                    <input
                      ...
                      name="name"
                      required
                      className="w-full border border-gray-300 p-3 rounded-lg inter focus:ring-2 focus:ring-[#C67139] focus:border-transparent"
                  ...
                  <div>
                    <button
                      type="submit"
                      className="bg-[#AA5C29] hover:bg-[#8C491A] text-white py-3 px-6 rounded-lg w-full outfit font-semibold transition-colors"
                    >
                      Send Message
                    </button>
                  </div>
