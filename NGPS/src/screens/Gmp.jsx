  ...
  return (
    <div className="min-h-screen bg-[#F5EAD8]">
      ...
      <main className="relative z-10">
        {/*------------------------------------------ Hero Section ------------------------------------------------------------*/}
        <section className="relative bg-gradient-to-br from-[#2E2B25] via-[#3D372E] to-[#2E2B25] py-20 md:py-32">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center text-white">
              <div className="inline-block bg-[#AA5C29]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a
                  ...
                  className="bg-white hover:bg-gray-100 text-[#201E1D] font-semibold py-4 px-8 rounded-full transition-all duration-300 transform hover:scale-105 shadow-xl outfit"
                >
                  Email Us
                </a>
              </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold text-[#201E1D] mb-4 outfit">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100">
                  <h3 className="text-2xl font-semibold text-[#201E1D] mb-6 outfit">Audit Types We Conduct</h3>
                  <ul className="space-y-4">
                    <li className="flex items-start space-x-3">
                      ...
                      <div>
                        <p className="font-semibold text-[#201E1D]">Vendor / Supplier Audits</p>
                    ...
                    <li className="flex items-start space-x-3">
                      ...
                      <div>
                        <p className="font-semibold text-[#201E1D]">Internal / Self-Inspection Audits</p>
                    ...
                    <li className="flex items-start space-x-3">
                      ...
                      <div>
                        <p className="font-semibold text-[#201E1D]">Mock USFDA / EDQM Inspections</p>
                    ...
                    <li className="flex items-start space-x-3">
                      ...
                      <div>
                        <p className="font-semibold text-[#201E1D]">For-Cause / Focused Audits</p>
                ...
                <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100">
                  <h3 className="text-2xl font-semibold text-[#201E1D] mb-6 outfit">Facilities We Audit</h3>
                  <ul className="space-y-3">
                    <li className="flex items-center space-x-3">
                      <svg className="w-5 h-5 text-[#C67139]" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div className="bg-blue-50 border-l-4 border-[#C67139] p-6 rounded-lg">
                <h3 className="text-xl font-semibold text-[#201E1D] mb-3 outfit">Regulatory Standards We Audit Against</h3>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-white p-6 rounded-xl shadow-md">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-lg text-[#201E1D] mb-2 outfit">Detailed Audit Report</h3>
                ...
                <div className="bg-white p-6 rounded-xl shadow-md">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-lg text-[#201E1D] mb-2 outfit">CAPA Recommendations</h3>
                ...
                <div className="bg-white p-6 rounded-xl shadow-md">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-lg text-[#201E1D] mb-2 outfit">Remediation Timelines</h3>
                ...
                <div className="bg-white p-6 rounded-xl shadow-md">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-lg text-[#201E1D] mb-2 outfit">Executive Summary</h3>
                ...
                <div className="bg-white p-6 rounded-xl shadow-md">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-lg text-[#201E1D] mb-2 outfit">Photographic Evidence</h3>
                ...
                <div className="bg-white p-6 rounded-xl shadow-md">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-lg text-[#201E1D] mb-2 outfit">Post-Audit Consultation</h3>
              ...
              <div className="mt-8 bg-[#AA5C29] text-white p-6 rounded-xl text-center">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                {/* Timelines */}
                <div>
                  <h2 className="text-3xl font-bold text-[#201E1D] mb-6 outfit">Typical Timelines</h2>
                  <div className="space-y-6">
                    <div className="flex items-start space-x-4">
                      <div className="bg-[#FFF2EB] rounded-full p-3 flex-shrink-0">
                        <svg className="w-6 h-6 text-[#C67139]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                      </div>
                      <div>
                        <h3 className="font-semibold text-lg text-[#201E1D] outfit">Vendor Audit</h3>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h3 className="font-semibold text-lg text-[#201E1D] outfit">Internal Self-Inspection</h3>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h3 className="font-semibold text-lg text-[#201E1D] outfit">Mock USFDA/EDQM Audit</h3>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h3 className="font-semibold text-lg text-[#201E1D] outfit">For-Cause / Focused Audit</h3>
                ...
                {/* Engagement Models */}
                <div>
                  <h2 className="text-3xl font-bold text-[#201E1D] mb-6 outfit">Engagement Models</h2>
                  <div className="space-y-6">
                    <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-6 rounded-xl border-l-4 border-[#C67139]">
                      <h3 className="font-semibold text-lg text-[#201E1D] mb-3 outfit">Project-Based</h3>
                      <p className="text-gray-700 text-sm mb-3">Single audit with defined scope and fixed deliverables</p>
                      <ul className="text-sm text-gray-600 space-y-1">
                        <li className="flex items-start">
                          <svg className="w-4 h-4 text-[#C67139] mr-2 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                            <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                          </svg>
                    ...
                    <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-6 rounded-xl border-l-4 border-[#C67139]">
                      <h3 className="font-semibold text-lg text-[#201E1D] mb-3 outfit">Retainer</h3>
                    ...
                    <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-6 rounded-xl border-l-4 border-[#C67139]">
                      <h3 className="font-semibold text-lg text-[#201E1D] mb-3 outfit">Embedded Support</h3>
                  ...
                  <div key={index} className="bg-white rounded-lg shadow-md overflow-hidden">
                    ...
                    >
                      <div className="flex items-start justify-between">
                        <h3 className="font-semibold text-lg text-[#201E1D] outfit pr-8">{faq.q}</h3>
                        <svg
                          className={`w-6 h-6 text-[#8C491A] flex-shrink-0 transform transition-transform duration-200 ${
        ...
        {/*--------------------------------------------- Final CTA -----------------------------------------------------------*/}
        <section className="py-16 bg-gradient-to-r from-[#C67139] to-[#B2622D] text-white">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a
                  href="mailto:inquiry@nexgenpharmasolutions.com"
                  className="bg-[#2E2B25] hover:bg-[#3D372E] text-white font-semibold py-4 px-8 rounded-full transition-all duration-300 transform hover:scale-105 shadow-xl outfit border-2 border-white"
                >
                  Email Us
                </a>
              </div>
